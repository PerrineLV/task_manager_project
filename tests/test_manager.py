...
class TestTaskManagerBasics:
    ...
    def test_get_task_existing(self):
        ...
        task_id = self.manager.add_task(
            "Test Task", "Test Description", Priority.MEDIUM
        )
...
class TestTaskManagerFiltering:
    ...
    def setup_method(self):
        ...
        self.manager = TaskManager("test_tasks.json")
        # Création de plusieurs tâches avec différents statuts et priorités
        # pour les tests
        ...
        self.task3_id = self.manager.add_task(
            "Task 3", "Description 3", Priority.MEDIUM
        )
...
class TestTaskManagerAdditional:
    ...
    def test_get_statistics(self):
        ...
        self.manager.add_task("Task 3", "Desc 3", Priority.MEDIUM)
